...
class RVcreate_acc extends StatelessWidget {
  RVcreate_acc({
    Key? key,
  }) : super(key: key);
  @override
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(start: 14.0, end: 19.3),
                  Pin(size: 251.0, middle: 0.6043),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
                        Pin(size: 43.0, middle: 0.25),
                        child: Stack(
                          children: <Widget>[
                            Container(
                              decoration: BoxDecoration(
                ...
                Pinned.fromPins(
                  Pin(start: 18.0, end: 22.3),
                  Pin(size: 41.0, middle: 0.2324),
                  child: Text(
                    'Create an Account',
                    style: TextStyle(
                      fontFamily: 'Raleway',
                      fontSize: 35,
                      color: const Color(0xff242a37),
                      letterSpacing: -0.010500000417232513,
                    ),
                    textAlign: TextAlign.center,
                    softWrap: false,
                  ),
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              ...
                              child: Text(
                                'Term and Conditions without reservation',
                                style: TextStyle(
                                  fontFamily: 'Raleway',
                                  fontSize: 12,
                                  color: const Color(0xff242a37),
                ...
                Pinned.fromPins(
                  Pin(size: 22.3, start: 1.0),
                  Pin(size: 17.1, start: 45.5),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
