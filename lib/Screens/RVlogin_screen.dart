...
import './RVProfile.dart';
import 'package:adobe_xd/page_link.dart';
import './RVforgot_password.dart';
import './RVcreate_acc.dart';
import './RVsplash_screen.dart';
import 'package:flutter_svg/flutter_svg.dart';

class RVlogin_screen extends StatelessWidget {
  RVlogin_screen({
    Key? key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(0.0, 0.5, -0.5, 0.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -104.5, end: -105.0),
                  Pin(size: 375.0, start: 105.0),
                  child: Transform.rotate(
                    angle: 4.7124,
                    child:
                        // Adobe XD layer: 'shutterstock-283021…' (shape)
                        Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image:
                              const AssetImage('assets/images/welcomepic.png'),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
                ...
                Pinned.fromPins(
                  Pin(start: -129.5, end: -130.0),
                  Pin(size: 375.0, start: 130.0),
                  child: Transform.rotate(
                    angle: 4.7124,
                    child:
                        // Adobe XD layer: 'shutterstock-283021…' (shape)
                        Container(
                      color: const Color(0x17242a37),
                    ),
                  ),
                ),
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.5),
                  Pin(size: 504.0, end: 0.0),
                  child: Stack(
                    children: <Widget>[
                      Align(
                      ...
                      Container(
                        ...
                        margin: EdgeInsets.fromLTRB(0.0, 23.0, 0.0, 0.0),
                      ),
                    ],
                  ),
                ),
                Pinned.fromPins(
                  Pin(start: 20.0, end: 15.2),
                  Pin(size: 20.0, start: 13.8),
                  child: Stack(
                    children: <Widget>[
                      Align(
                ...
                Pinned.fromPins(
                  Pin(start: 34.0, end: 34.5),
                  Pin(size: 408.0, end: 48.0),
                  child: Stack(
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 116.0),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              Pin(start: 0.0, end: 0.0),
                                  ...
                                  Pinned.fromPins(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        letterSpacing: -0.012000000476837159,
                ...
                Pinned.fromPins(
                  Pin(size: 18.2, start: 29.0),
                  Pin(size: 17.1, start: 59.5),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
...
const String _svg_jb2pro =
    '<svg viewBox="1740.2 108.8 8.5 17.1" ><path transform="translate(-1.0, 0.0)" d="M 1749.715209960938 108.8413619995117 L 1741.168823242188 117.3877563476562 L 1749.715209960938 125.9341506958008" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_ttmj8 =
    '<svg viewBox="1740.8 117.4 17.5 1.0" ><path  d="M 1740.812622070312 117.3877563476562 L 1758.32275390625 117.3877563476562" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
